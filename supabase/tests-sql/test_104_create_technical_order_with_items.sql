  ...
  $q$
    ...
    BEGIN
      ...
      INSERT INTO public.products (name, category, stock_total, stock_reservado)
        VALUES ('Test 104 Product 1', 'equipment', 10, 0) RETURNING id INTO v_product_id;
...
SELECT throws_ok(
  $q$
    ...
    BEGIN
      ...
      INSERT INTO public.products (name, category, stock_total, stock_reservado)
        VALUES ('Test 104 Product 2', 'equipment', 10, 0) RETURNING id INTO v_product_id;
...
SELECT throws_ok(
  $q$
    ...
    BEGIN
      ...
      INSERT INTO public.products (name, category, stock_total, stock_reservado)
        VALUES ('Test 104 Product 3', 'equipment', 10, 0) RETURNING id INTO v_product_id;
...
SELECT lives_ok(
  $q$
    ...
    BEGIN
      ...
      INSERT INTO public.products (name, category, stock_total, stock_reservado)
        VALUES ('Test 104 Product 4', 'equipment', 10, 0) RETURNING id INTO v_product_id;
